        ...
        base.methods = {
            ...
            setup: function() {
                ...
                $.each(questions, function(i, question) {
                    ...
                    quizHtml += '<p class="question">' + question.question + '</p>';
                ...
                // quizHtml += '<div class="correct_answer-wrapper"><i class="fa fa-check"></i> <span id="correct-answer"></span> </div>';
            ...
            answerQuestion: function(answerEl) {
                ...
                var $answerEl = $(answerEl),
                   ...
                   correct = questions[currentQuestionIndex].options.indexOf(questions[currentQuestionIndex].correct_answer);
                   
                if (selected === correct) {
                    $answerEl.addClass('correct');
                    response = questions[currentQuestionIndex].correct_response;
                    score++;
                } else {
                    $answerEl.addClass('incorrect');
                    response = questions[currentQuestionIndex].incorrect_response;
                ...
                // $('#correct-answer').empty().toString(correct);
